...
At Mjølner, we are committed to safeguarding your data and ensuring transparent, secure, and compliant data handling practices across all of our applications developed for the ServiceNow platform.

This policy applies to all Mjølner-developed applications, present and future, and outlines how data is collected, used, stored, transferred, and protected when using our apps.

## 1. Data Collection

Mjølner applications operate within your ServiceNow environment and may process data that you or your users choose to input or interact with. This may include - but is not limited to - form inputs, user interactions, task data, records, or integrations configured by you.
...
Data collected by Mjølner applications is used strictly for:
...
- Mjølner does not collect, store, or transfer customer data outside of ServiceNow.

## 4. Data Sharing

Mjølner does not share any application data with third parties. Our applications do not transmit data to Mjølner servers or external services unless the customer has implemented such configurations independently.
...
Mjølner provides tools and configuration options but does not access or control any customer data.

## 7. Regulatory Compliance

Mjølner applications are designed to support compliance with relevant data protection regulations (e.g., GDPR, CCPA) through:
